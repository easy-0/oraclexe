...
데이터 유형
    ...
    CHAR(size) 고정 길이 문자 데이터 (최대 2000)
...
/*
CTAS는 "Cteate Table As Select" 의 약자로
...
제약조건(Constraint)
    ...
    위해 테이블 생성 또는 병경시 설정하는 조건입니다. (저장된 데이터의 신뢰성 높이기위함)
